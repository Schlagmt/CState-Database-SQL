...
VALUES		(1,1,1)
			,(2,2,2)
-- --------------------------------------------------------------------------------
-- Step #3.4: Write the join that will display the course ID, name, description and meeting 
--            times along with the instructor information and the room information.  
...
SELECT
	...
	,TC.strDescription
	,TI.intInstructorID
	,TI.strFirstName + ' ' + TI.strLastName AS strInstructorName
	,TI.strPhoneNumber
	,TR.intRoomID
	,TR.strRoomNumber
	,TR.intCapacity
...
-- --------------------------------------------------------------------------------
-- Step #3.5: Write the join that will show display a record for every student in a course 
